...
@section('content')
    @include('includes.delinsertroomreqall')
    <div class="row">
        <div class="col-md-5 col-md-offset-4">
            <h1>Room Insert Request</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-2">
            <a href="{{ route('asstprovost.roominsertallowall') }}" class="btn btn-lg btn-block btn-success btn-h1-spacing">Accept All</a>
        </div>
        <div  class="col-md-4">
    ...
    <script>
        $(function() {
            $('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('asstprovost.roomreqinsert') !!}',
                columns: [
                    {data:'id',name:'id'},
